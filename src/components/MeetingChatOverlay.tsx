...
const UserMessage: React.FC<{ content: string }> = ({ content }) => (
    ...
    >
        <div className="bg-accent-primary/15 border border-accent-primary/20 text-white px-5 py-3 rounded-2xl rounded-tr-md max-w-[70%] text-[15px] leading-relaxed">
            {content}
        </div>
    </motion.div>
);
            ...
            {isOpen && (
                ...
                >
                    ...
                    <motion.div
                        ...
                        className="relative mx-auto w-full max-w-[680px] mb-0 bg-bg-secondary dark:bg-bg-primary rounded-t-[24px] border-t border-x border-border-subtle shadow-2xl overflow-hidden flex flex-col"
                        onClick={(e) => e.stopPropagation()}
                    >
                        {/* Header with close button */}
                        <div className="flex items-center justify-between px-4 py-3 border-b border-border-subtle shrink-0">
                            <div className="flex items-center gap-2 text-text-tertiary">
                                <img src={smarterliIcon} className="w-3.5 h-3.5 brightness-0 dark:brightness-100 dark:opacity-50 dark:grayscale" alt="logo" />
