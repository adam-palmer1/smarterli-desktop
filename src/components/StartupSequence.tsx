...
const StartupSequence: React.FC<StartupSequenceProps> = ({ onComplete }) => {
    ...
    return (
        <div className="fixed inset-0 z-[100] bg-[#0D0D0D] flex items-center justify-center overflow-hidden">
            {/* Volumetric Backlight - Adds depth/atmosphere */}
            <motion.div
                className="absolute w-96 h-96 bg-orange-500/10 rounded-full blur-[120px]"
            ...
            <motion.img
                ...
                animate={{
                    ...
                    filter: [
                        ...
                        'grayscale(0) brightness(1) drop-shadow(0 0 20px rgba(232,117,10,0.3))'   // White + Orange Glow/Bloom
                    ]
                }}
                transition={{
