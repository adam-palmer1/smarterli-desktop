        ...
        <AnimatePresence>
            {isVisible && (
                ...
                >
                    ...
                    >
                        <div className="relative glass-panel-heavy overflow-hidden">
                                ...
                                {status === 'ready' && (
                                    <div className="flex w-full gap-3">
                                        ...
                                        <button
                                            ...
                                            className="flex-1 py-[6px] bg-accent-primary/70 hover:bg-accent-primary active:scale-[0.98] text-[13px] font-medium text-white rounded-[8px] transition-all duration-200 shadow-[0_1px_2px_rgba(0,0,0,0.2)]"
                                        >
                                            Install
                                        </button>
                                    </div>
