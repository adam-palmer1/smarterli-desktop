...
const Launcher: React.FC<LauncherProps> = ({ onStartMeeting, onOpenSettings }) => {
    ...
    return (
        <div className="h-full w-full flex flex-col bg-bg-primary text-text-primary font-sans overflow-hidden selection:bg-accent-secondary/30">
            {/* 1. Header (Static) */}
            <header className="relative h-[40px] shrink-0 flex items-center justify-between pl-0 pr-2 drag-region select-none bg-transparent border-b border-border-subtle z-[200]">
                ...
                <AnimatePresence mode="wait">
                    {selectedMeeting ? (
                        ...
                        >
                            ...
                            {/* TOP SECTION: Glass Cards */}
                            <section className="px-8 pt-6 pb-8 border-b border-border-subtle shrink-0">
                                <div className="max-w-4xl mx-auto space-y-4">
                                    ...
                                    <div className="flex items-center justify-between">
                                        <div className="flex items-center gap-4">
                                            ...
                                            <button
                                                ...
                                                className={`p-2 text-text-secondary hover:text-text-primary hover:bg-white/10 rounded-full transition-colors ${isRefreshing ? 'animate-spin text-orange-400' : ''}`}
                                                title="Refresh State"
                                            >
                                                <RefreshCw size={18} />
                                            </button>
                                    ...
                                    shadow-[inset_0_1px_1px_rgba(255,255,255,0.5),inset_0_-1px_2px_rgba(0,0,0,0.1),0_2px_10px_rgba(232,117,10,0.4),0_0_0_1px_rgba(255,255,255,0.10)]
                                    hover:shadow-[inset_0_1px_2px_rgba(255,255,255,0.6),inset_0_-1px_3px_rgba(0,0,0,0.15),0_6px_20px_rgba(232,117,10,0.5),0_0_0_1px_rgba(255,255,255,0.15)]
                                ...
                                "
                                        >
                                            {/* Top Highlight Band */}
                                            <div className="absolute inset-x-3 top-0 h-[40%] bg-gradient-to-b from-white/30 to-transparent blur-[2px] rounded-b-lg opacity-80 pointer-events-none" />
                                    ...
                                    <div className="space-y-4">
                                        ...
                                        {isPrepared && preparedEvent ? (
                                            <div className="glass-panel relative group overflow-hidden border border-emerald-500/30 flex flex-col items-center justify-center p-6 bg-gradient-to-br from-emerald-500/5 via-transparent to-transparent">
                                            ...
                                            nextMeeting ? (
                                                <div className="glass-panel relative group overflow-hidden flex flex-col bg-gradient-to-br from-orange-500/5 via-transparent to-transparent">
                                                    {/* Header */}
                                                    ...
                                                    {/* Actions */}
                                                    <div className="p-4 border-t border-glass-border flex items-center gap-3">
                                                        <button
                                                            onClick={() => handlePrepare(nextMeeting)}
                                                            className="flex-1 bg-white/5 hover:bg-white/10 border border-white/10 text-white px-4 py-2 rounded-lg text-xs font-medium transition-all flex items-center justify-center gap-2"
                                                        >
                                                            ...
                                                            <div className="flex items-center gap-4">
                                                                {m.title === 'Processing...' ? (
                                                                    <div className="flex items-center gap-2 transition-all duration-200 ease-out group-hover:opacity-0 group-hover:translate-x-2 delayed-hover-exit">
                                                                        ...
                                                                        <span className="text-xs text-orange-500 font-medium">Finalizing...</span>
                                                                    </div>
                                                                ) : (
                                                                    <>
                                                                        <span className="relative z-10 bg-white/[0.08] text-text-tertiary text-[9px] px-1.5 py-0.5 rounded-full font-medium min-w-[35px] text-center tracking-wide">
                ...
                {showNotification && (
                    ...
                    >
                        ...
                        <div className="relative flex items-center justify-center w-9 h-9 rounded-full bg-gradient-to-b from-orange-400/20 to-orange-600/20 shadow-[inset_0_1px_0_rgba(255,255,255,0.2)] border border-white/5">
                            ...
                            <RefreshCw size={15} className="text-orange-300 animate-[spin_2s_linear_infinite] drop-shadow-[0_0_5px_rgba(232,117,10,0.6)]" />
                        </div>
