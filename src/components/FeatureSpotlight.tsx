...
export const FeatureSpotlight: React.FC = () => {
    ...
    return (
        <div
            className="relative h-full w-full overflow-hidden rounded-xl bg-gradient-to-br from-[#111111] to-[#0D0D0D] flex flex-col group select-none"
                    ...
                    {currentFeature.type === 'premium' && (
                        ...
                        >
                            <div
                                ...
                                style={{
                                    background: 'radial-gradient(circle, rgba(232, 117, 10, 0.15) 0%, rgba(232, 117, 10, 0) 70%)',
                                }}
                            />
                        </motion.div>
                    )}
                ...
                <AnimatePresence initial={false}>
                    ...
                    >
                        ...
                        {currentFeature.eyebrow && (
                            <div className="mb-2 text-[11px] font-semibold tracking-[0.15em] text-orange-400/80 uppercase">
                                {currentFeature.eyebrow}
                            </div>
                        )}
                            ...
                            >
                                ...
                                <h2
                                    ...
                                    style={{
                                        ...
                                        fontWeight: 500,
                                        lineHeight: 1.1,
                                        color: (isPremium || isSupport) ? '#F59E0B' : '#ffffff', // Orange for Premium & Support
                                    ...
                                    <div className={`flex flex-col w-full max-w-[340px] gap-1 items-center translate-y-2.5`}>
                                        {currentFeature.bullets.map((bullet, idx) => (
                                            <div key={idx} className={`flex items-center justify-center group/item transition-transform duration-200 px-2`}>
                                                <span
                                                    className={`${isSupport ? 'text-[12px] leading-relaxed font-medium opacity-100' : 'text-[12.5px] leading-snug font-medium'} text-[#F59E0B]`}
                                ...
                                {!isPremium && (
                                    <motion.button
                                        ...
                                        className={`
                                            ...
                                            cursor-pointer
                                            ${isSupport
                                                ? 'mt-2 translate-y-5 px-6 py-2 text-[13px] font-medium text-white'
                                                : 'px-10 py-2.5 text-[13px] font-medium text-[#F5F7FA]'
                                            }
                                        `}
                                        style={isSupport ? {
                                            background: 'linear-gradient(180deg, #F59E0B 0%, #E8750A 100%)',
                                            boxShadow: `
                                                0 6px 20px rgba(232, 117, 10, 0.35),
                                            ...
                                            >
                                                ...
                                                >
                                                    {isSupport ? (
                                                        ...
                                                        <Bell
                                                            size={14}
                                                            className={`${isInterested ? 'text-orange-400' : 'opacity-80'}`}
