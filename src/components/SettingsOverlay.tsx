...
import {
    ...
    ChevronDown, Check, BadgeCheck, Power, Palette, Sun, Moon, RefreshCw, Info, FlaskConical, Trash2, LayoutGrid, Plus, Pencil, Users
} from 'lucide-react';
...
const SettingsOverlay: React.FC<SettingsOverlayProps> = ({ isOpen, onClose, onLogout }) => {
