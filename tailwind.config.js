...
module.exports = {
  ...
  theme: {
    extend: {
      ...
      boxShadow: {
        glass: 'var(--shadow-md), inset 0 0.5px 0 var(--glass-highlight)',
        'glass-heavy': 'var(--shadow-lg), inset 0 1px 0 var(--glass-highlight)',
        'glass-glow': 'var(--shadow-md), var(--shadow-glow-blue)',
      },
